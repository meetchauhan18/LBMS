...
const BookTable = ({
    ...
    const memoizedPaginatedBooks = useMemo(() => {
    ...
    // Handle sorting for author and book columns
    ...
    return (
        ...
        <TableContainer component={Paper} sx={{overflowX: 'auto' }}>
            ...
            <Table>
                <TableHead sx={{ backgroundColor: '#e5e5e5', color: '#fff' }}>
                    <TableRow>
                        <TableCell sx={{ fontWeight: 'bold', border: '2px solid rgb(244, 130, 130)' }} align='center'>Sr No.</TableCell>
                        <TableCell sx={{ fontWeight: 'bold', border: '2px solid rgb(244, 130, 130)' }} align='center'>
                            Author Name
                        ...
                        <TableCell sx={{ fontWeight: 'bold', border: '2px solid rgb(244, 130, 130)' }} align='center'>Action</TableCell>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {memoizedPaginatedBooks.map((book, idx) => (
